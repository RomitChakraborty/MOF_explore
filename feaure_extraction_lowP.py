...
feature_columns = [col for col in data.columns if col not in ['Unnamed: 0', target_variable, 'pure_uptake_CO2_298.00K_16bar']]
...
plt.title('Top 10 Features for Predicting CO2 Uptake (Excluding CO2 Uptake at 16 bar)')
